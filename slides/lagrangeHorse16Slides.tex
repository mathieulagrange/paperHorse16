...
\item public horse
\item hidden horses
\item Potemkin Village
\end{itemize}
\end{frame}


\begin{frame}{NMF-based Source separation}
is an example of a "public" horse
\begin{itemize}
...
\begin{itemize}
\item everyone is happy with it
\item badly designed tasks
\item too small and biased datasets
\end{itemize}
\end{frame}

\begin{frame}{A Potemkin Village in Acoustic Scene Similarity Retrieval (ASSR)}
\begin{itemize}
\item
\item
\item
